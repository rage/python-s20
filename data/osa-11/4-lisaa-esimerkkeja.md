...
- `koodarit(self)` palauttaa listana kaikki koodarit, joille on tehtävä tilauskirjassa, metodi palauttama lista ei saa sisältää yhtä koodaria useampaan kertaan
